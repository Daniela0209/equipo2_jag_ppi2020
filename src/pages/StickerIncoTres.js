...
import StickerGatoDos from "../imagenes/StickerGatoDos.jpg";
import fondoSticker from "../imagenes/fondoSticker.jpg";

class StickerIncoTres extends React.Component {
  render() {
    return (
      <div
...
export default StickerIncoTres;
